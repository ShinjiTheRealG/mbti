...
var prompts = [{
  ...
  {
    prompt: 'You tend to be very critical with what other people want, or you often criticize yourself and others for not having thought through all the consquences/possibilities',
    ISTJ: 0,
    ISTP: 2,
    INTJ: 0,
    INFJ: 0,
